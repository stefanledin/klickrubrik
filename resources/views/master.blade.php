                ...
                <form action="">
                    <fieldset class="headline-maker__text">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input class="input input--text" type="text" name="who" id="who" v-model="who" placeholder="Vem?">
                        </div>
                        
                        <div class="input-wrapper">
                            <label for="what">att</label>
                            <input class="input input--text" type="text" name="what" v-model="what" placeholder="Vad?" id="what">
                        </div>
                        
                        <div class="input-wrapper">
                            <select class="input input--select" v-model="punchline" name="punchline" id="punchline">
                    ...
                    <fieldset class="headline-maker__attachment">
                        ...
                        <ul class="icon-group">
                            <li class="icon-group__icon" v-bind:class="{'icon-group__icon--selected': (attachmentType === 'uploaded-image')}">
                                <label class="headline-maker__attachment__icon">
                                    ...
                                    Ladda upp bild
                                    <input type="radio" v-model="attachmentType" name="attachment" value="uploaded-image">
                                </label>
                            </li>
                            <li class="icon-group__icon" v-bind:class="{'icon-group__icon--selected': (attachmentType === 'image-link')}">
                                <label class="headline-maker__attachment__icon">
                                    ...
                                    Länk till bild
                                    <input type="radio" v-model="attachmentType" name="attachment" value="image-link">
                                </label>
                            </li>
                            <li class="icon-group__icon" v-bind:class="{'icon-group__icon--selected': (attachmentType === 'youtube-video')}">
                                <label class="headline-maker__attachment__icon">
                                    ...
                                    YouTube-länk
                                    <input type="radio" v-model="attachmentType" name="attachment" value="youtube-video">
                                </label>
                            </li>
                        </ul>
                        ...
                        <div v-if="attachmentType === 'uploaded-image'" class="input-wrapper">
                            ...
                            <input id="file-upload" class="input input--file" type="file">
                        </div>
                        
                        <div v-if="attachmentType === 'image-link'" class="input-wrapper">
                            <input class="input input--text" type="text" v-model="imageLink" v-on:keyup="loadImageLink" debounce="2000" placeholder="Länk till bild">
                        </div>
                        
                        <div v-if="attachmentType === 'youtube-video'" class="input-wrapper">
                            <input class="input input--text" type="text" v-model="youtubeVideo" placeholder="Länk till YouTube">
                        </div>
            ...
            <div class="preview-wrapper vh">
                <div class="preview">
                    <div class="preview__inner">
                        ...
                        <div v-if="!attachment" class="preview__attachment-placeholder">
                            <div>?!!</div>
                        </div>
                        <div v-show="attachment" id="attachment-container" v-html="attachment"></div>
                    </div>
                </div>
            </div>
