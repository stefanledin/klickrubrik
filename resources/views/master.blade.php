                        ...
                        <ul class="icon-group">
                            <li class="icon-group__icon">
                                <label class="headline-maker__attachment__icon">
                                    ...
                                    Ladda upp bild
                                    <input type="radio" name="attachment" value="uploaded-image">
                                </label>
                            </li>
                            <li class="icon-group__icon">
                                <label class="headline-maker__attachment__icon">
                                    ...
                                    Länk till bild
                                    <input type="radio" name="attachment" value="image-link">
                                </label>
                            </li>
                            <li class="icon-group__icon">
                                <label class="headline-maker__attachment__icon">
                                    ...
                                    YouTube-länk
                                    <input type="radio" name="attachment" value="youtube-video">
                                </label>
                            </li>
                        </ul>
                    </fieldset>
